...
@section('content')
    ...
    <p class="lead">Here's a list of all your BillOthers List. <a href="{{ route('BillingOthers.create') }}"> Add a new one?</a></p>
    <hr>
            ...
            @foreach($items as $item)
                @if($item->trashed())
                    <tr class="">
                        ...
                        <!--<td class="text-center"><a href="{{ route('BillingFinalOthers.show', $item->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>-->
                ...
                @else
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ route('BillingFinalOthers.show', $item->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>
                        <td class="text-center"><a href="{{ route('BillingFinalOthers.edit', $item->id) }}" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                        <td class="text-center">
                            {!! Form::open([
                               'method' => 'DELETE',
                               'route' => ['BillingFinalOthers.destroy', $item->id]
                           ]) !!}
