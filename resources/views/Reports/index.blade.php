...
@section('content')
    ...
    <div class="col-md-2"><button type="button" class="btn-success form-control" id="reportbydate">View</button></div>
    <div class="col-md-2"><button type="button" class="btn-danger form-control" id="reportbydateprint">Print</button></div>
