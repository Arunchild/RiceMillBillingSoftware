...
@section('content')
    ...
    <p class="lead">Edit and save this PurchaseKurunaibelow, or <a href="{{ route('PurchaseKurunai.index') }}">go back to PurchaseKurunai.</a></p>
    <hr>
    ...
    <div class="row">
        ...
        {!! Form::model($items, [
            'method' => 'PATCH',
            'route' => ['PurchaseKurunai.update', $items->id]
        ]) !!}
