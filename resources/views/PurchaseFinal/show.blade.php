...
<p class="lead text-center">See All. <a href="{{ route('PurchaseFinal.index') }}"> Go Back?</a></p>
<hr>

@include('partials.alerts.errors')

{!! Form::open([
    'route' => 'Purchase.store', 'id' => 'formidda'
]) !!}
    ...
    <table class="table table-bordered table-condensed table-hover table-responsive">
        ...
        @foreach($items as $item)
            <tr>
                ...
                <td class="text-center"><a href="{{ route('Purchase.edit', $item->id) }}" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
               <!-- <td class="text-center hidden-print">
                    {!! Form::open([
                       'method' => 'DELETE',
                       'route' => ['Purchase.destroy', $item->id]
                   ]) !!}
