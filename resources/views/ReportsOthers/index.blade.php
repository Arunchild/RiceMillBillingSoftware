...
@section('content')
    ...
    <div class="col-md-2"><button type="button" class="btn-success form-control" id="reportbydateothers">View</button></div>
    <div class="col-md-2"><button type="button" class="btn-danger form-control" id="reportbydateprintothers">Print</button></div>
