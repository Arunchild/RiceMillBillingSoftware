...
@section('content')
    ...
    <p class="lead">Edit and save this ProductMaster Kurunai below, or <a href="{{ route('ProductMasterKurunai.index') }}">go back to ProductMaster Kurunai.</a></p>
    <hr>
    ...
    <div class="row">
        ...
        {!! Form::model($items, [
            'method' => 'PATCH',
            'route' => ['ProductMasterKurunai.update', $items->id]
        ]) !!}
