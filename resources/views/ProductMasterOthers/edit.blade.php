...
@section('content')
    ...
    <p class="lead">Edit and save this ProductMaster below, or <a href="{{ route('ProductMasterOthers.index') }}">go back to ProductMasterOthers.</a></p>
    <hr>
    ...
    <div class="row">
        ...
        {!! Form::model($items, [
            'method' => 'PATCH',
            'route' => ['ProductMasterOthers.update', $items->id]
        ]) !!}
