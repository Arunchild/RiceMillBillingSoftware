...
<p class="lead text-center">See All. <a href="{{ route('BillingFinal.index') }}"> Go Back?</a></p>
<hr>

@include('partials.alerts.errors')

{!! Form::open([
    'route' => 'Billing.store', 'id' => 'formidda'
]) !!}
...
<div class="clearfix"></div>
<div class="col-md-1 col-md-offset-11"><input value="{{ $finaldatas->id }}" class="hidden" id="bill_print_id"/> <button type="button" class="btn btn-danger" id="bill_print">Print</button></div>
@stop