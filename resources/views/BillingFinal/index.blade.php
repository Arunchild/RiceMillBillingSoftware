            ...
            @foreach($items as $item)
                @if($item->trashed())
                    <tr class="">
                        ...
                        <!--<td class="text-center"><a href="{{ route('BillingFinal.show', $item->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>-->
                ...
                @else
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ route('BillingFinal.show', $item->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>
                        <td class="text-center"><a href="{{ route('BillingFinal.edit', $item->id) }}" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                        <td class="text-center">
                            {!! Form::open([
                               'method' => 'DELETE',
                               'route' => ['BillingFinal.destroy', $item->id]
                           ]) !!}
